<section class="bg-[#0A0914] py-24 text-white">
	<div class="mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2">
		...
		<div class="space-y-8">
			...
			<!-- FINAL NOTE -->
			<p
				class="pt-4 font-['Satoshi_Variable'] text-[18px] leading-[120%] font-medium tracking-[0.5%] text-[#FAFAFF] opacity-74"
			>
				Notifications aren't a growth hack. They're UX glue. And we built them so you wouldn’t have
				to.
			</p>
		</div>
		...
		<div class="flex justify-center lg:justify-end">
			<img
				src="/multi-channel-notification.png"
				alt="dummy"
